...
extern int rockpi_mcu_is_mcu_power_on(void);
...
#if 0	
input_set_abs_params(input_dev, ABS_MT_TRACKING_ID, 0, MAX_TOUCH_POINTS, 0, 0);
#endif
	...
	input_set_abs_params(input_dev, ABS_MT_POSITION_Y, 0,
			     SCREEN_HEIGHT, 0, 0);
#if 0	
	input_set_abs_params(input_dev, ABS_X, 0, SCREEN_WIDTH, 0, 0);
	input_set_abs_params(input_dev, ABS_Y, 0, SCREEN_HEIGHT, 0, 0);
#endif	
